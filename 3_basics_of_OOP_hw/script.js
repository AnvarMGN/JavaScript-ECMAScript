...
class Employee {
    ...
    displayInfo() {
        console.log(`Имя: ${this.nameEmployee}`);
    }
}

const employee = new Employee('Иванов Иван');
...
class Manager extends Employee {
    ...
    displayInfo() {
        console.log(`Имя: ${this.nameEmployee}, Отдел: ${this.managerDepartment}`);
    }
}

const manager = new Manager('Иванов Пётр', 'Продажи');
manager.displayInfo();
...
class Order {
    ...
    getTotalPrice() {
        let totalPrice = 0;
        this.productsArray.forEach(product => totalPrice += product.productPrice * product.productQuantity);
        return totalPrice;
    }
}
